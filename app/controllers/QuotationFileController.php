	...
	public function upload(){
		if($this->f3->exists('POST.submit1')){
			if($this->f3->get('FILES.quotation_file_receipt["name"]') != ''){
				$quotation_file_receipt = $this->f3->get('POST.quotation_number').'/quotation_file_receipt.'.pathinfo($this->f3->get('FILES.quotation_file_receipt["name"]'), PATHINFO_EXTENSION);
			} else {
				$quotation_file_receipt = $this->f3->get('POST.quotation_file_receipt_temp');
			}
			
			self::upload_file($this->f3->get('FILES.quotation_file_receipt'), 'quotation_file_receipt', $this->f3->get('POST.quotation_number'));
			...
			if($this->f3->get('FILES.quotation_file_delivery["name"]') != ''){
				$quotation_file_delivery = $this->f3->get('POST.quotation_number').'/quotation_file_delivery.'.pathinfo($this->f3->get('FILES.quotation_file_delivery["name"]'), PATHINFO_EXTENSION);
			} else {
				$quotation_file_delivery = $this->f3->get('POST.quotation_file_delivery_temp');
			}
			
			self::upload_file($this->f3->get('FILES.quotation_file_delivery'), 'quotation_file_delivery', $this->f3->get('POST.quotation_number'));
			...
			if($this->f3->get('FILES.quotation_file_fip["name"]') != ''){
				$quotation_file_fip = $this->f3->get('POST.quotation_number').'/quotation_file_fip.'.pathinfo($this->f3->get('FILES.quotation_file_fip["name"]'), PATHINFO_EXTENSION);
			} else {
				$quotation_file_fip = $this->f3->get('POST.quotation_file_fip_temp');
			}
			
			self::upload_file($this->f3->get('FILES.quotation_file_fip'), 'quotation_file_fip', $this->f3->get('POST.quotation_number'));
			...
			if($this->f3->get('FILES.quotation_file_delivery_cancel["name"]') != ''){
				$quotation_file_delivery_cancel = $this->f3->get('POST.quotation_number').'/quotation_file_delivery_cancel.'.pathinfo($this->f3->get('FILES.quotation_file_delivery_cancel["name"]'), PATHINFO_EXTENSION);
			} else {
				$quotation_file_delivery_cancel = $this->f3->get('POST.quotation_file_delivery_cancel_temp');
			}
			
			self::upload_file($this->f3->get('FILES.quotation_file_delivery_cancel'), 'quotation_file_delivery_cancel', $this->f3->get('POST.quotation_number'));
			...
			if($this->f3->get('FILES.quotation_file_fip_agreement["name"]') != ''){
				$quotation_file_fip_agreement = $this->f3->get('POST.quotation_number').'/quotation_file_fip_agreement.'.pathinfo($this->f3->get('FILES.quotation_file_fip_agreement["name"]'), PATHINFO_EXTENSION);
			} else {
				$quotation_file_fip_agreement = $this->f3->get('POST.quotation_file_fip_agreement_temp');
			}
			
			self::upload_file($this->f3->get('FILES.quotation_file_fip_agreement'), 'quotation_file_fip_agreement', $this->f3->get('POST.quotation_number'));
			...
			if($this->f3->get('FILES.quotation_file_po_wo["name"]') != ''){
				$quotation_file_po_wo = $this->f3->get('POST.quotation_number').'/quotation_file_po_wo.'.pathinfo($this->f3->get('FILES.quotation_file_po_wo["name"]'), PATHINFO_EXTENSION);
			} else {
				$quotation_file_po_wo = $this->f3->get('POST.quotation_file_po_wo_temp');
			}
			
			self::upload_file($this->f3->get('FILES.quotation_file_po_wo'), 'quotation_file_po_wo', $this->f3->get('POST.quotation_number'));
			...
			$this->f3->set('quotation_number', $this->f3->get('POST.quotation_number'));
			
			$quotation_file = new QuotationFile($this->db);
			$quotation_file->getById($this->f3->get('PARAMS.quotation_id'));
			
			$this->f3->set('page_title','PENAWARAN : '.$this->f3->get('POST.quotation_number'));
			$this->f3->set('header','header/header.html');
			$this->f3->set('view','quotation/upload.html');
		}
	}
